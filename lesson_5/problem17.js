...
// even when some of those items were created on a different server or
// by a different application. That is, without any synchronization,
// two or more computer systems can create new items and label them
// with a UUID with no significant risk of stepping on each other's
// toes. It accomplishes this feat through massive randomization.
...
// Each UUID consists of 32 hexadecimal characters (the digits 0-9
//   and the letters a-f) represented as a string. The value is
//   typically broken into 5 sections in an 8-4-4-4-12 pattern,
