...
// less than 4 components, e.g., 4.5.5 or 1.2.3.4.5: both those values
// should be invalid."
...
function isDotSeparatedIpAddress(inputString) {
  ...
  if (dotSeparatedWords.length !== 4) {
    console.log(`Your address has ${dotSeparatedWords.length} components.`);
    console.log(`Address must only have 4 components (e.g., 10.4.5.11)`);
    return false;
  }
...
console.log(isDotSeparatedIpAddress('10.4.111'));